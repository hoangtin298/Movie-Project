...
export declare const sortedGridRowsSelector: import("reselect").OutputSelector<GridState, Map<GridRowId, import("../../../models/gridRows").GridRowData>, (res1: GridRowId[], res2: GridRowsLookup) => Map<GridRowId, import("../../../models/gridRows").GridRowData>>;
